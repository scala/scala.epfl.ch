...
* Compiler profiling gifs (Visual Studio Code):
    * https://drive.google.com/open?id=0BwSyjC598iaiaGEyeEdyQXNRZWc
    * https://drive.google.com/open?id=0BwSyjC598iaicndXelJHTHNZXzQ
    * https://drive.google.com/open?id=0BwSyjC598iaic0I4XzZBMS0wdHc
    * https://drive.google.com/open?id=0BwSyjC598iaiU3E5QXF0RWlRVzg
* Scastie autocompletion + embedded mode (interactive documentation):
    * https://drive.google.com/open?id=0BwSyjC598iaiQWNZLVlBbE9nX0E
    * https://drive.google.com/open?id=0BwSyjC598iaiYU0ydTNSRGpHd2s

The following notes are a supplement to Heather's report:

**Scalafix**: Seth asked what major work was left to do on Scalafix,
e.g. for a 1.0 release. Heather's answer: rewrites are currently
mostly just syntactic; full support for semantic rewrites will require
more work on the underlying Scalameta technology.
...
hopes it could make Scala 2.14, at least as experimental.  Martin also
voiced his support for pulling the rework into Dotty as soon as it is
ready.
...
Martin expects a Ph.D student of his would participate as well.
