...
([Read the bolg article](https://www.scala-lang.org/blog/2017/11/03/zinc-blog-1.0.html))
...
- Work on a better build and test workflow for Zinc. The scripted integration
   ...
   happen. The rework of the build is splited into several PRs ([#438][#438],
...
* [sbt-dependency-graph](https://github.com/jrudolph/sbt-dependency-graph) is a tool to understand how your
  external dependencies are wired togetter. It's essential to debug anomalies on the classpath. [PR #140](https://github.com/jrudolph/sbt-dependency-graph/pull/140) [PR #139](https://github.com/jrudolph/sbt-dependency-graph/pull/139) ([@MasseGuillaume])
...
- Overrode a bunch of methods in strict collections, for peprformance [#305](https://github.com/scala/collection-strawman/pull/305).
